...
export default function ProjectContent({ projects, showAll = false }: ProjectGalleryProps) {
  ...
  return (
    <>
      {/* Custom layout for 3 or more */}
      {visibleProjects.length >= 3 ? (
        <>
          {/* First 3 projects in custom layout */}
